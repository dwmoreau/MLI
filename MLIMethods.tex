...
This write-up is meant to explain the methods in the data-driven indexing approach. I am very interested in feedback on the methods. There has been very little refinement whatsoever and likely considerable room for improvement.
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=6cm]{/Users/DWMoreau/MLI/models/triclinic_v0/data/regression_inputs_aP_00.png}
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=6cm]{/Users/DWMoreau/MLI/models/triclinic_v0/data/covariance_inputs.png}
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=6cm]{/Users/DWMoreau/MLI/models/triclinic_v0/augmentor/aug_setup_triclinic_v0.png}
...
\begin{minipage}{0.45\textwidth}
  \centering
  \includegraphics[totalheight=13cm]{/Users/DWMoreau/MLI/models/triclinic_v0/data/hkl_labels_unaugmented_aP.png}
  \caption{Unaugmented}
\end{minipage}
\begin{minipage}{0.45\textwidth}
  \centering
  \includegraphics[totalheight=13cm]{/Users/DWMoreau/MLI/models/triclinic_v0/data/hkl_labels_augmented_aP.png}
  \caption{Augmented}
\end{minipage}
\begin{center}
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=12cm]{/Users/DWMoreau/MLI/models/triclinic_v0/regression/aP_reg.png}
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=12cm]{/Users/DWMoreau/MLI/models/triclinic_v0/regression/aP_reg_tree.png}
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=4cm]{/Users/DWMoreau/MLI/models/triclinic_v0/template/aP_dominant_zone_ratio_trclinic_v0.png}
...
\begin{minipage}{0.45\textwidth}
  \centering
  \includegraphics[totalheight=4cm]{/Users/DWMoreau/MLI/models/triclinic_v0/assigner/aP_assignment_group_v3_mC_0.png}
\end{minipage}
\begin{minipage}{0.45\textwidth}
  \centering
  \includegraphics[totalheight=4cm]{/Users/DWMoreau/MLI/models/triclinic_v0/assigner/assignment_calibration_group_v3_mC_0.png}
\end{minipage}
\begin{center}
...
\begin{minipage}{0.45\textwidth}
  \centering
  \includegraphics[totalheight=4cm]{/Users/DWMoreau/MLI/models/triclinic_v0/assigner/aP_assignment_group_v3_mC_1.png}
\end{minipage}
\begin{minipage}{0.45\textwidth}
  \centering
  \includegraphics[totalheight=4cm]{/Users/DWMoreau/MLI/models/triclinic_v0/assigner/assignment_calibration_group_v3_mC_1.png}
\end{minipage}
\begin{center}
...
\begin{minipage}{0.45\textwidth}
  \centering
  \includegraphics[totalheight=4cm]{/Users/DWMoreau/MLI/models/triclinic_v0/assigner/aP_assignment_group_v3_mC_2.png}
\end{minipage}
\begin{minipage}{0.45\textwidth}
  \centering
  \includegraphics[totalheight=4cm]{/Users/DWMoreau/MLI/models/triclinic_v0/assigner/assignment_calibration_group_v3_mC_2.png}
\end{minipage}
\begin{center}
...
Neural Network & 340 & 2.3\% \\
Random Forest & 257 & 5.4\% \\ 
Templates & 85 & 2.6\% \\ \hline
Neural Network \& Random Forest & 150 & 3.8\% \\
Neural Network \& Templates & 72 &  2.4\% \\ 
Random Forest \& Templates & 64 & 4.0\% \\
All & 58 & 3.4\% \\
\end{tabular}
\end{center}
