...
Peak lists are created by identifying peaks in diffraction patterns. Diffraction patterns are calculated using the Computation Crystallography Tool box (CCTBX) with parameters based on internal datasets collected at SACLA in the fall of 2023 and spring of 2024. Each entry is loaded by a cif file and CCTBX is used to produce a peak list of all possible peaks between $2\theta = 1^o$ to $25^o$, at the wavelength of $\lambda = 0.827$ $\mathrm{\AA}$. This peak list contains the peak's integrated intensity, position in $2\theta$, and Miller indices. Intensities are scaled for the Lorentz-Polarization factor and peak positions are converted to units of $q^2 = 1/d^2 = \left[\frac{2\sin(\theta)}{\lambda}\right]^2$. A breadth is calculated for each peak using the formula $\beta = \beta_0 + \beta_1 q^2$. Peak breadths of experimental smSFX patterns were estimated and the parameterization of $\beta_0 = 0.00007$ and $\beta_1 = 0.002$ represents the average pattern. Three peak lists are created based on broadening of 2/3, 1, and 1.5 times this parameterization. Diffraction patterns are then created by summing gaussians with the amplitudes, locations, and standard deviations equal to the peak list's integrated intensities, peak position in $q^2$, and breadths respectively. The summation axis occurs between $2\theta = 2^o$ to $25^o$ in steps 0.01 $2\theta$.
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=6cm]{/Users/DWMoreau/MLI/models_old/triclinic_1/data/regression_inputs_aP_00.png}
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=6cm]{/Users/DWMoreau/MLI/models_old/triclinic_1/data/covariance_inputs.png}
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=6cm]{/Users/DWMoreau/MLI/models_old/triclinic_1/augmentor/aug_setup_triclinic_1.png}
...
\begin{minipage}{0.45\textwidth}
  \centering
  \includegraphics[totalheight=13cm]{/Users/DWMoreau/MLI/models_old/triclinic_1/data/hkl_labels_unaugmented_aP.png}
  \caption{Unaugmented}
\end{minipage}
\begin{minipage}{0.45\textwidth}
  \centering
  \includegraphics[totalheight=13cm]{/Users/DWMoreau/MLI/models_old/triclinic_1/data/hkl_labels_augmented_aP.png}
  \caption{Augmented}
\end{minipage}
\begin{center}
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=12cm]{/Users/DWMoreau/MLI/models_old/triclinic_1/regression/aP_reg.png}
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=12cm]{/Users/DWMoreau/MLI/models_old/triclinic_1/regression/aP_reg_tree.png}
...
\begin{figure}
\begin{center}
\includegraphics[totalheight=4cm]{/Users/DWMoreau/MLI/models_old/triclinic_1/template/aP_dominant_zone_ratio_triclinic_1.png}
