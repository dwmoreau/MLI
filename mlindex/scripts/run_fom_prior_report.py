"""Results document for a prior-network fit: regenerate `<tag>.md` and its figure from the CSVs.

    python -m mlindex.scripts.run_fom_prior_report --tag S14_prior

Ported by S14 from campaign 1's `S11` report (`fom@7c137c3`); only the defaults changed.
